...
<script>
    function materials_tagSliderBar () {
        return {
            ...
            create_folder() {
                this.create_folder_url = '{{ route('material_tag_folders.store') }}';
            },
            update_folder(item) {
                this.id = item.id;
                this.name = item.name;
                this.update_folder_url = '{{ route('material_tag_folders.update', 'ref-id') }}'.replace('ref-id', item.id);
            },
            drop_folder(item) {
                this.id = item.id;
                this.name = item.name;
                this.drop_folder_url = '{{ route('material_tag_folders.destroy', 'ref-id') }}'.replace('ref-id', item.id);
            },
            reset() {
