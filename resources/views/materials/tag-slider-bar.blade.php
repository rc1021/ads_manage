<div class="block max-w-xs mx-auto p-6 bg-whitering-1 ring-slate-900/5 space-y-3">
    ...
    <div class="bg-white px-4 space-y-3">
        <a href="{{ route('materials.index', array_merge($query, ['act' => 'tag-edit'])) }}" class="items-center text-base font-semibold text-slate-900 dark:text-slate-200">
    ...
    <div class="bg-white px-4 space-y-3">
        ...
        @foreach ($tag_parents as $parent)
            <a href="{{ route('materials.index', array_merge($query, ['tid' => $parent->id])) }}" class="block text-slate-900 dark:text-slate-200 {{ $tag_id == $parent->id ? 'text-main-400' : '' }}">
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 w-full text-center sm:mt-0 sm:ml-4 sm:text-left space-y-4">
                        ...
                        <div class="relative w-full group">
                            ...
                            <select wire:model.lazy="parent_id" id="parent" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-main-500 focus:border-main-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-main-500 dark:focus:border-main-500">
                                <option value="">--</option>
