<div class="flex space-x-4 mt-4">
    ...
    <div class="inline-flex rounded-md shadow-sm" role="group">
        <a href="{{ route('materials.index', array_merge($query, ['type' => 1])) }}" class="group inline-flex items-center rounded-l-lg p-3 py-2 {{ ($type != 1) ? 'bg-white' : 'bg-main-500 ring-main-500' }} shadow space-y-3 hover:bg-main-500 ring-1 ring-slate-900/5">
        ...
        <a href="{{ route('materials.index', array_merge($query, ['type' => 2])) }}" class="group inline-flex items-center p-3 py-2  {{ ($type != 2) ? 'bg-white' : 'bg-main-500 ring-main-500' }} shadow space-y-3 hover:bg-main-500 ring-1 ring-slate-900/5">
            <span class="flex items-center space-x-1">
        ...
        <a href="{{ route('materials.index', array_merge($query, ['type' => 8])) }}" class="group inline-flex items-center rounded-r-lg p-3 py-2  {{ ($type != 8) ? 'bg-white' : 'bg-main-500 ring-main-500' }} shadow space-y-3 hover:bg-main-500 ring-1 ring-slate-900/5">
            <span class="flex items-center space-x-1">
