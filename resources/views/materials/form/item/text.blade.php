                ...
                <div>
                    <div class="flex border-b">
                        <div class="flex flex-col flex-1">
                            <input type="text" x-model="texts[index]" name="texts[]" class="w-full border-0 focus:outline-none p-2 sm:text-sm border-gray-300 rounded-md" :placeholder="'{{ __('Copy ') }}' + (index + 1)" autocomplete="off">
                        </div>
