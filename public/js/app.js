    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            if (!(input.type != 'file' || input.dataset.rel != 'part-upload')) {
              _context2.next = 7;
              break;
            }
              ...
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _loop$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      blob = input.files.item(i), file = new FileCreator(blob, input.dataset.url, input.dataset.limit); // 為 blob 建立素材資料

                      _context.next = 3;
                      return axios.post(form.action, {
                        title: file.get('name'),
