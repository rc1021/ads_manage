...
document.addEventListener("DOMContentLoaded", function (event) {
  var _iterator = _createForOfIteratorHelper(document.querySelectorAll('[data-rel="vtt-background"]')),
      _step;
    ...
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      item.addEventListener("mouseenter", function (event) {
        this.dataset.interval = setInterval(function () {
          ...
          var text = this.cues[this.ind].text;
          var url = new URL(text);
          var xywh = url.hash.split('=').pop().split(',');
...
/******/ 		var installedChunks = {
/******/ 			"/resources/assets/js/material": 0,
/******/ 			"resources/assets/css/material": 0
/******/ 		};
/******/ 		
...
/******/ 	__webpack_require__.O(undefined, ["resources/assets/css/material"], () => (__webpack_require__("./resources/js/material.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["resources/assets/css/material"], () => (__webpack_require__("./resources/css/material.css")))
