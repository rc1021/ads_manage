<nav aria-label="Breadcrumb">
    <ol class="inline-flex items-center py-1  space-x-1 md:space-x-3">
        <li class="inline-flex items-center">
            <a href="{{ route('material.items.index') }}" class="inline-flex items-center text-lg text-gray-700 hover:text-gray-900">
        ...
        <li>
            ...
            <span class="ml-1 text-lg font-medium text-gray-700 hover:text-gray-900 md:ml-2">{{ __('垃圾桶') }}</span>
            </span>
        </li>
        @elseif($tag)
