    ...
    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8 flex-1">
        <div class="inline-block py-2 min-w-full sm:px-6 lg:px-8 gap-2">
            <div class="max-w-screen-lg flex flex-wrap gap-2 p-1 pt-1.5">
                ...
                <a href="#" class="group relative shadow bg-gray-200 bg-stripes bg-stripes-white min-w-[11rem]">
                    @if($item->mediaable)
                    ...
                    @endif
                    <div class="absolute flex justify-between justify-items-end items-end top-0 inset-x-0 h-full text-sm">
                        <div class="flex p-1">
