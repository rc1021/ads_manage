...
if (!function_exists('material_path')) {
    ...
    {
        return ucfirst(config('material.directory')).($path ? DIRECTORY_SEPARATOR.$path : $path);
    }
}
...
if (!function_exists('material_url')) {
     ...
     * @return string
     */
    function material_url($path = '', $parameters = [], $secure = null)
    {
        if (\Illuminate\Support\Facades\URL::isValidUrl($path)) {
            return $path;
        }

        $secure = $secure ?: (config('material.https') || config('material.secure'));

        return url(material_base_path($path), $parameters, $secure);
    }
}

if (!function_exists('material_base_path')) {
    /**
     * Get admin url.
     *
     * @param string $path
     ...
     * @return string
     */
    function material_base_path($path = '')
    {
        $prefix = '/'.trim(config('material.route.prefix'), '/');
...
if (!function_exists('material_toastr')) {
     ...
     * @param array  $options
     */
    function material_toastr($message = '', $type = 'success', $options = [])
    {
...
if (!function_exists('material_error')) {
     ...
     * @param string $message
     */
    function material_error($title, $message = '')
    {
        material_info($title, $message, 'error');
    }
}

if (!function_exists('material_warning')) {
     ...
     * @param string $message
     */
    function material_warning($title, $message = '')
    {
        material_info($title, $message, 'warning');
    }
}

if (!function_exists('material_info')) {
     ...
     * @param string $type
     */
    function material_info($title, $message = '', $type = 'info')
    {
...
if (!function_exists('material_asset')) {
     ...
     * @return string
     */
    function material_asset($path)
    {
        return config('material.https') ? secure_asset($path) : asset($path);
    }
}

if (!function_exists('material_trans')) {
     ...
     */
    function material_trans($key = null, $replace = [], $locale = null)
    {
...
if (!function_exists('material_dump')) {
...
if (!function_exists('material_get_route')) {
    function material_get_route(string $name): string
    {
        return config('material.route.prefix').'.'.$name;
    }
}
