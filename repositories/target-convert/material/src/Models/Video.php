...
use TargetConvert\Material\Jobs\ConvertVideoForDownloading;
use TargetConvert\Material\Jobs\ConvertVideoForStreaming;
use TargetConvert\Material\Jobs\ConvertVideoForThumbing;
...
class Video extends Model
{
    ...
    {
        $this->setTable(config('material.database.video_table'));
